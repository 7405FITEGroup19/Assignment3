...
class Application:
    ...
    def __createMenu(self):
        ...
        filemenu.add_command(label = "Pricer 1: Black-Scholes Formulas", command=self.task1)
        filemenu.add_command(label = "Pricer 2: Implied Volatility", command=self.task2)
